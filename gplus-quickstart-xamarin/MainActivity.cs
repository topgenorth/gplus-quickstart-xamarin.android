...
namespace gplusquickstartxamarin
{
    /// <summary>
    ...
    public class MainActivity : Activity, IGoogleApiClientConnectionCallbacks, IGoogleApiClientOnConnectionFailedListener, IResultCallback
    {
